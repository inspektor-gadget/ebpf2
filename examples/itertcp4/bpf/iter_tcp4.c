...
static const unsigned CONFIG_HZ = 250;
// extern unsigned CONFIG_HZ __kconfig; Not supported by bpf2go "can't load BPF from ELF: load BTF: reference to .kconfig: not supported"
